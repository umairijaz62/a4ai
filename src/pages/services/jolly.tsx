...
export default function jolly() {
  return (
    <main className="min-h-screen bg-blue-50">
      <Navbar />
      <Hero image="/bgjolly.jpg" imageName="Jolly Phonics" heading="Jolly Phonics" text="Fun and Engaging phonice learning for kids! orksheet, video & tips to build strong reading skills," />
